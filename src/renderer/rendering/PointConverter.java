...
public class PointConverter {
    ...
    public static Point convertPoint(CellPoint point3D) {
    ...
    // SOH CAH TOA
    public static void rotateAxisX(CellPoint point, boolean clockWise, double degrees) {
    ...
    public static void rotateAxisY(CellPoint point, boolean clockWise, double degrees) {
    ...
    public static void rotateAxisZ(CellPoint point, boolean clockWise, double degrees) {
